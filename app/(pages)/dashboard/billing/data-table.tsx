...
export const columns: any = [
  {
    ...
    header: "Invoice",
    cell: ({ row }: { row: any }) =>
      // <Link className="underline" href={row.getValue("url")}>
      //   {row.getValue("id")}
      // </Link>
      row.getValue("id"),
  },
  {
    ...
    cell: ({ row }: { row: any }) => row.getValue("billing_period"),
  },
  {
    accessorKey: "status",
    header: "Status",
  ...
  },
  {
    accessorKey: "amount",
    header: "Amount",
    cell: ({ row }: { row: any }) => <div>${row.getValue("amount")}</div>,
  },
];

export function InvoicesDataTable({ data }: { data: any }) {
